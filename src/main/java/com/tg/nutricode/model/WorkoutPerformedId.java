...
public class WorkoutPerformedId implements Serializable {
    ...
    public WorkoutPerformedId() {
    }

    public WorkoutPerformedId(String user, LocalDate date) {
        this.user = user;
        this.date = date;
    }
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof WorkoutPerformedId))
            return false;
        WorkoutPerformedId that = (WorkoutPerformedId) o;
