...
public class WeightLogId implements Serializable {
    ...
    public WeightLogId(String user, LocalDate date) {
        this.user = user;
        this.date = date;
    }
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof WeightLogId))
            return false;
        WeightLogId that = (WeightLogId) o;
